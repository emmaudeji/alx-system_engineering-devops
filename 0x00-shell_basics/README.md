...
Project done at alx zero-day courses.
Objectives is to learn about Shell basic commands.

Technologies used are scripting in Bash and script were checked on Ubuntu.

Below is the script for each task
