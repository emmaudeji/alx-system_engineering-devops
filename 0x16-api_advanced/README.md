...
In this project I used the Reddit API to practice API call. There's a lot of endpoints available, many that don't require any form of authentication, and there's tons of information to be parsed out and presented.
...
[Done with the mandatory tasks? Unlock 1 advanced task now!](https://alx-intranet.hbtn.io/projects/314/unlock_optionals)
